...
export const fadeIn = (direction, delay = 0.1) => {
    return {
        hidden: {
            opacity: 0,
...
// 2. Scale and Fade In
export const scaleFadeIn = (delay = 0.1) => {
    return {
...
export const rotateSlideIn = (direction = 'up', delay = 0.1) => {
    let x = 0;
    let y = 0;
...
// 4. Bounce In
export const bounceIn = (delay = 0.1) => {
    return {
